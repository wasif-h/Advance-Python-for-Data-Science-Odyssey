...
# installed.
TCL_PREFIX='W:/AI_Learning/DSKN/Advance-Python-for-Data-Science-Odyssey/env312\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='W:/AI_Learning/DSKN/Advance-Python-for-Data-Science-Odyssey/env312\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='W:/AI_Learning/DSKN/Advance-Python-for-Data-Science-Odyssey/env312\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IW:/AI_Learning/DSKN/Advance-Python-for-Data-Science-Odyssey/env312\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LW:/AI_Learning/DSKN/Advance-Python-for-Data-Science-Odyssey/env312\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='W:/AI_Learning/DSKN/Advance-Python-for-Data-Science-Odyssey/env312\Library\lib\tclstub86.lib'
